...
class Widget extends BaseWidget
{
    ...
    const INLINE_JS_KEY = 'app/widgets/redactor/';
    ...
    {
        if (!isset(Yii::$app->i18n->translations['app/imperavi']) && !isset(Yii::$app->i18n->translations['app/imperavi/*'])) {
            Yii::$app->i18n->translations['app/imperavi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@app/widgets/redactor/messages',
                'forceTranslation' => true,
                'fileMap' => [
                    'app/imperavi' => 'imperavi.php'
                ]
            ];
        }
    }
